<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST"){
        ...
        $picture = "../profile_pictures/nopictures.jpg";
        

        if($password == $Cpassword){


            $sql = "INSERT INTO registrations (first_name,last_name,email_address,username,password,profile) VALUES ('$fname','$lname','$email','$username','$password','$picture')";
